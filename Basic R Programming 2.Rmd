...
```
```{r}
diamonds[0,]#called a tibble, tells us what the variables are
#can't use this one to change a variable name
```
...
diamonds$carat #then you can print the new variable to see what you got.
...
#do this instead
diamonds$carat2<- as.numeric(diamonds$carat2)[diamonds$carat2]
```
